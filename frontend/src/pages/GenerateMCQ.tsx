...
const GenerateMCQ: React.FC = () => {
  ...
  const getOptionStyle = (option: string, mcq: MCQ, questionIndex: number) => {
    ...
    if (!selected) return "bg-white border-gray-200 hover:border-gray-300 text-gray-700";
    
    if (option === mcq.answer) return "bg-green-50 border-green-300 text-green-800";
    if (isSelected) return "bg-red-50 border-red-300 text-red-800";
