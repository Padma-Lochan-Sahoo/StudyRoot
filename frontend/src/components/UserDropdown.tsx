...
const UserDropdown = ({ userName, userImage }: UserDropdownProps) => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <div className="hidden sm:flex flex-col items-start min-w-0 flex-1">
            <span className="text-black/90 font-medium text-sm lg:text-base truncate max-w-[120px] lg:max-w-[150px] group-hover:text-black transition-colors duration-300">
              {userName}
            </span>
            <span className="text-black/60 text-xs hidden lg:block">
      ...
      <DropdownMenuContent 
        align="end" 
        className="w-48 sm:w-56 lg:w-64 bg-white/95 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-2 mt-2"
        sideOffset={8}
      >
        ...
        <DropdownMenuItem 
          ...
          className="flex items-center space-x-3 px-3 py-2.5 hover:bg-blue-50/50 rounded-xl transition-all duration-200 cursor-pointer group"
        >
        ...
        {authUser?.role === "admin" && (
          <DropdownMenuItem
            ...
            className="flex items-center space-x-3 px-3 py-2.5 hover:bg-purple-50/50 rounded-xl transition-all duration-200 cursor-pointer group"
          >
        ...
        <DropdownMenuItem 
          ...
          className="flex items-center space-x-3 px-3 py-2.5 hover:bg-red-50/50 rounded-xl transition-all duration-200 cursor-pointer group"
        >
